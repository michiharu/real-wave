...
const generateWaveParams = (): WaveParams[] => {
  return [waveRandomParams(30, 600), waveRandomParams(20, 400), waveRandomParams(15, 200)];
};
  ...
  useEffect(() => {
    ...
    setWavesState((state) => {
      ...
      const waves = state.map((w) => {
        const line = (w.line + elapsed / 15) % endLine;
